...
-- Toute nouvelle fonction ou nouveau flux visible de l addon doit aussi etre ajoute ici.
local INFOS_GUIDE_LINES = {
  "Bienvenue dans EasySanalune.",
  "",
  "Ce guide t aide a prendre l addon en main rapidement, cote joueur puis cote MJ.",
  "Si tu debutes, commence par la section suivante et reviens ici au besoin.",
  "",
  "==============================",
  "1) A quoi sert l addon ?",
  "==============================",
  "- EasySanalune regroupe ta fiche, tes rands, tes buffs/debuffs et les outils MJ.",
  "- Cote joueur, tu prepares ton profil puis tu lances tes jets plus vite.",
  "- Cote MJ, tu peux gerer des mobs, envoyer des attaques et resoudre les demandes.",
  "",
  "==============================",
  "2) Demarrage rapide cote joueur",
  "==============================",
  "1. Ouvre la fenetre joueur avec /easy pj.",
  "2. Cree ou choisis un profil. Si tu n as pas, fais /easy profils",
  "3. Ouvre Fiche et regle tes seuils, tes PDV et ton armure.",
  "4. Ajoute tes categories puis tes rands principaux.",
  "5. Ouvre Buffs pour saisir tes bonus et malus courants.",
  "6. Coche Lire resultat rand si tu veux une lecture plus automatique.",
  "",
  "Ordre conseille pour debuter:",
  "- Profil -> Fiche -> Rands -> Buffs -> test de jet.",
  "",
  "==============================",
  "3) Mainframe joueur (/easy pj)",
  "==============================",
  "- La fenetre principale centralise tout ce qui concerne ton personnage.",
  "- Tu peux la deplacer par le titre et la redimensionner avec la poignee.",
  "- Le bouton ^ jaune replie rapidement la fenetre.",
  "",
  "Boutons du header:",
  "- Reset: remet le profil courant a zero apres confirmation.",
  "- Infos: ouvre ce guide.",
  "- Buffs: ouvre la fenetre Buffs / Debuffs.",
  "- Fenetre MJ: ouvre les outils MJ si la case MJ est activee.",
  "- Fiche: ouvre les reglages de survie et de critique.",
  "",
  "Cases utiles:",
  "- Message raid: envoie le contexte du jet dans le canal groupe/raid si disponible.",
  "- Lire resultat rand: aide a relire le jet et l issue correspondante.",
  "- MJ: active les fonctions MJ et la synchronisation associee.",
  "- Resolution privee: prefere une resolution discrete quand c est possible.",
  "",
  "==============================",
  "4) Profils (/easy profils)",
  "==============================",
  "- Un profil garde ta fiche, tes rands, tes buffs et l ordre de tes categories.",
  "- Utilise un profil par personnage, role ou scene si besoin.",
  "- Le menu Profil sert a changer vite de configuration.",
  "",
  "Actions de profil:",
  "- Nouveau: cree un profil vide.",
  "- Renommer: change le nom du profil courant.",
  "- Exporter: copie un texte complet pour sauvegarde ou partage.",
  "- Importer: recree un profil a partir d un export.",
  "",
  "==============================",
  "5) Categories et rands",
  "==============================",
  "- Les categories servent a ranger tes rands par theme.",
  "- Clic gauche sur une categorie: reduire ou etendre.",
  "- Clic droit sur une categorie ou un rand: modifier l element.",
  "",
  "Actions au survol d une ligne:",
  "- Edit: ouvre l edition.",
  "- x: supprime l element.",
  "- ^: remonte l element.",
  "- v: descend l element.",
  "",
  "Quand tu cliques sur un rand:",
  "- le jet est lance avec tes valeurs actuelles, buffs inclus,",
  "- le texte d info est recalcule selon le contexte,",
  "- si un MJ a synchronise des mobs, un rand offensif peut demander une cible avant le jet.",
  "",
  "==============================",
  "6) Buffs / Debuffs",
  "==============================",
  "- Ouvre cette fenetre avec le bouton Buffs.",
  "- Elle est deplacable, redimensionnable et garde sa position.",
  "- Tu peux creer des categories de buffs comme pour les rands.",
  "",
  "Ce qu il faut retenir:",
  "- un buff peut viser une stat, plusieurs stats ou un rand personnalise precis,",
  "- les effets se voient tout de suite dans les valeurs affichees,",
  "- Soutien profite du x2 seulement avec Toutes les stats ou Toutes les stats offensives.",
  "",
  "==============================",
  "7) Fiche (crits, PDV, armure)",
  "==============================",
  "- La Fiche contient tes seuils offensifs et defensifs ainsi que ta survie.",
  "- Valeurs par defaut: 5 PDV, armure Nue, esquive de dos a 50%.",
  "- Tu peux regler Crit off, Crit def, Esquive de dos, PDV et type d armure.",
  "- Armure Speciale permet aussi de choisir Durabilite, RDA et RDA critique.",
  "",
  "Astuce:",
  "- le panneau Actuellement au survol peut afficher PDV, armure, durabilite, RDA et RDA critique.",
  "",
  "==============================",
  "8) Jouer avec un MJ",
  "==============================",
  "- Si un MJ utilise l addon, certaines actions deviennent plus guidees.",
  "- Tes attaques offensives peuvent ouvrir un choix de mob si le MJ a fait Rafraichir.",
  "- Quand le MJ t attaque, tu recois une alerte contextuelle avec les boutons de defense adaptes.",
  "- Tu peux donc reagir sans chercher manuellement la bonne fenetre.",
  "",
  "==============================",
  "9) Fenetre MJ (/easy mj)",
  "==============================",
  "- Active d abord la case MJ dans le header.",
  "- La fenetre MJ sert a gerer les mobs, les cibles joueurs et les resolutions.",
  "",
  "Bloc mobs:",
  "- Clic gauche: selectionne le mob actif.",
  "- Clic droit: ouvre l edition du mob.",
  "- Nouveau / Sauvegarder / Supprimer font vivre ta liste de mobs.",
  "- Importer un profil permet de transformer vite une fiche joueur en base de mob.",
  "- Rafraichir envoie la liste actuelle des mobs aux joueurs ayant l addon.",
  "",
  "Bloc attaque MJ -> joueur:",
  "- Choisis la cible dans la liste ou ajoute-la manuellement.",
  "- Le bouton Ajouter groupe/raid recupere les joueurs connectes du groupe.",
  "- Atk phys et Atk mag envoient l attaque selon le type choisi.",
  "- La case Attaque de dos applique la logique de dos sur l esquive.",
  "",
  "==============================",
  "10) Demandes en attente et historique (MJ)",
  "==============================",
  "- Cette zone affiche les attaques joueurs en attente de resolution.",
  "- Verifie le mob selectionne puis clique sur la defense adaptee.",
  "- Historique conserve les 5 dernieres actions de la session.",
  "- Certaines entrees proposent Relancer pour rejouer rapidement une action.",
  "",
  "==============================",
  "11) Commandes utiles",
  "==============================",
  "- /easy pj : ouvre ou ferme la fenetre joueur.",
  "- /easy mj : ouvre ou ferme la fenetre MJ.",
  "- /easy profils : active ou coupe le mode profils.",
  "",
  "==============================",
  "12) Depannage express",
  "==============================",
  "- Un bouton manque: c est souvent normal, beaucoup d actions sont conditionnelles.",
  "- Un jet semble faux: verifie le profil courant, la fiche et les buffs actifs.",
  "- Une attaque MJ ne part pas: verifie la cible, le mob actif et la case MJ.",
  "- Un joueur ne voit rien: verifie qu il a l addon et que la synchro MJ a bien ete faite.",
  "",
  "Fin du guide."
}
