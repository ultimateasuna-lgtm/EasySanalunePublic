...
local STRINGS = {
  ...
  profiles_help = "/easy profils pour les options profils, /easy pj pour ouvrir la fenêtre joueur, /easy mj pour ouvrir la fenêtre MJ, /easy debug pour les traces crit",
  ...
  ui_toggle_issue_whisper = "Chuchotement only",
  ...
  ui_label_movement_speed = "Vitesse de déplacement (%) :",
  ui_display_name = "Nom d'affichage :",
  ...
  ui_player_defense_attack_type_phy = "Type: attaque physique",
  ui_player_defense_attack_type_mag = "Type: attaque magique",
  ui_player_defense_modal_info = "%s attaque (%d-%d)%s. Choisis ta défense.",
  ui_rand_announce = "Rand %s",
  ...
  mj_attack_combo = "Combo mob",
  mj_attack_no_dodge = "Non esq",
  mj_attack_no_defense = "Non def",
  ...
  mj_attack_btn_aoe = "AOE",
  mj_aoe_modal_title = "Attaque de zone (AOE)",
  mj_aoe_players_label = "Joueurs ciblés :",
  mj_aoe_no_targets = "Aucun joueur dans la liste.",
  mj_aoe_no_selection = "Sélectionne au moins un joueur.",
  mj_aoe_sent = "AOE %s → %d joueur(s) (%d-%d).",
  ...
  mj_pending_btn_def_phy = "Def phys",
  mj_pending_btn_def_mag = "Def mag",
  mj_pending_btn_dodge = "Esquive",
  mj_history_button = "Historique",
  mj_combat_button = "Combat",
  ...
  mj_combat_title = "Combat",
  mj_combat_start_side = "Camp qui commence :",
  mj_combat_side_enemy = "Ennemi",
  mj_combat_side_ally = "Allié",
  mj_combat_start_button = "Début du combat",
  mj_combat_next_button = "Suite",
  mj_combat_stop_button = "Fin du combat",
  mj_combat_duration_label = "Temps du tour:",
  mj_combat_reset_history_button = "Reset historique",
  mj_combat_state_idle = "Combat inactif.",
  mj_combat_state_running = "Combat en cours — Tour %d, %s",
  mj_combat_state_time_suffix = " | Temps: %ds",
  mj_combat_players_label = "Joueurs:",
  mj_combat_players_none = "aucun",
  mj_combat_player_status_played = "a joue",
  mj_combat_player_status_pending = "en attente",
  mj_combat_movement_suffix = " — Dépl. %d%%",
  mj_combat_movement_exceeded = " — Dépl. dépassé !",
  mj_movement_alert = "|cffff4040[Déplacement]|r %s a dépassé son déplacement : %d%% utilisé pour %d%% autorisé (Tour %d, %s).",
  movement_indicator_text = "Déplacement : %d%%",
  movement_indicator_rolled = "Déplacement : 0% (rand lancé)",
  movement_indicator_exceeded = "Déplacement dépassé !",
  mj_combat_history_empty = "Aucun événement de combat.",
  mj_combat_not_started = "Le combat n'est pas démarré.",
  mj_combat_already_started = "Un combat est déjà en cours.",
  ...
  modal_followup_label = "Suivi :",
  modal_followup_none = "Aucun",
  modal_followup_prefix = "Suivi : %s",
  modal_followup_rand_line = "Suivi du rand : %s",
